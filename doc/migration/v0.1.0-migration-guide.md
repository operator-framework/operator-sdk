...
For any user defined dependencies added to the old project's go.mod, copy and append them to the new project's go.mod.
Run `go mod vendor` to update the vendor in the new project.
