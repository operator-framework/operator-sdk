...
type ScorecardFormatter interface { //nolint:golint
	// todo(camilamacedo86): The no lint here is for pkg/apis/scorecard/formatting.go:25:6: type name will be used as
	//  scorecard.ScorecardFormatter by other packages, and that stutters; consider calling this Formatter (golint)
