...
- Added new `--bundle` flag to the `operator-sdk scorecard` command to support bundle validation testing. ([#1916](https://github.com/operator-framework/operator-sdk/pull/1916)
