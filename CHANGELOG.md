...
- New command [`operator-sdk olm-catalog gen-catalogsource`](https://github.com/operator-framework/operator-sdk/blob/master/doc/sdk-cli-reference.md#gen-catalogsource) that prints a combined [CatalogSource](https://github.com/operator-framework/operator-marketplace#catalogsourceconfig) and [ConfigMap](https://cloud.google.com/kubernetes-engine/docs/concepts/configmap) manifest to be piped into `kubectl`, applied to a cluster, and managed by OLM. ([#1552](https://github.com/operator-framework/operator-sdk/pull/1552))
