...
- Use `registry.access.redhat.com/ubi7/ubi-minimal:latest` base image for the Ansible and Helm operators and scorecard proxy ([#1376](https://github.com/operator-framework/operator-sdk/pull/1376))
