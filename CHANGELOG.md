...
- Fix levels of verbose informed by `ansible.operator-sdk/verbosity` annotation for Ansible based-operators. ([#2651](https://github.com/operator-framework/operator-sdk/pull/2651))
