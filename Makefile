...
# E2E tests.
.PHONY: test-e2e test-e2e-go test-e2e-go-new test-e2e-helm-new test-e2e-ansible test-e2e-ansible-molecule test-e2e-helm test-e2e-helm-new-shell

test-e2e: test-e2e-go test-e2e-go-new test-e2e-helm-new test-e2e-ansible test-e2e-ansible-molecule test-e2e-helm test-e2e-helm-new-shell ## Run the e2e tests
