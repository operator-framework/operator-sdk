...
`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if err := printDeps(viper.GetString(config.RepoOpt), c.asFile); err != nil {
	...
	printDepsCmd.Flags().BoolVar(&c.asFile, "as-file", false, "Print dependencies in go.mod or Gopkg.toml file format, depending on the dependency manager chosen when initializing or migrating a project")

	return printDepsCmd
}

func printDeps(repo string, asFile bool) error {
