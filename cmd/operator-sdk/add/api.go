...
Example:
	...
	apiCmd.Flags().StringVar(&c.APIVersion, "api-version", "", "Kubernetes APIVersion that has a format of $GROUP_NAME/$VERSION (e.g app.example.com/v1alpha1)")
	...
	apiCmd.Flags().StringVar(&c.Kind, "kind", "", "Kubernetes resource Kind name. (e.g AppService)")
