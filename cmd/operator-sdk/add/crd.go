...
These files are generated in deploy/crds if crds-dir is not set in the projects' config file.

Generated CRD filename: <group>_<version>_<kind>_crd.yaml
Generated CR  filename: <group>_<version>_<kind>_cr.yaml
