...
func newAddCRDCmd() *cobra.Command {
	crdCmd := &cobra.Command{
		...
		Long: `The operator-sdk add crd command will create a Custom Resource Definition (CRD) and the Custom Resource
				(CR) files for the specified api-version and kind.
