...
`,
	...
	scorecardCmd.Flags().String(scorecard.ConfigOpt, "", fmt.Sprintf("config file (default is"+
		" '<project_dir>/%s'; the config file's extension and format can be .yaml, .json, or .toml)",
