...
- The scorecard configuration format for the `operator-sdk scorecard` command has changed. See the [scorecard docs](../../test-framework/scorecard) for more info.
...
[print-deps-cli]: ../../sdk-cli-reference#print-deps
[changelog]: ../../changelog
