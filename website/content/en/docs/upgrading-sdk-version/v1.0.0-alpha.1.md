...
## In `v3-alpha` PROJECT files, add the `projectName` config key to your PROJECT file
...
- Replace runtime creation of the metrics `Service` and `ServiceMonitor` with deploy-time kustomize templates
