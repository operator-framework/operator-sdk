...
See [the contributor guide][contrib] for details on submitting patches and the contribution workflow.
...
[install_guide]: {{< ref "install-operator-sdk.md" >}}
[operator_link]: https://coreos.com/operators/
[proposals_docs]: /docs/proposals
[sdk_cli_ref]: {{< ref "sdk-cli-reference.md" >}}
[guide]: /docs/user/
...
[controller_runtime]: https://github.com/kubernetes-sigs/controller-runtime
[ansible_user_guide]: /docs/ansible/user-guide/
[helm_user_guide]: /docs/helm/user-guide/
[faq]: /docs/faq/
