...
require (
	...
	github.com/operator-framework/operator-sdk v0.0.0-20190328171801-5a439ae7f4e9
...
replace (
	...
	k8s.io/apiserver => k8s.io/apiserver v0.0.0-20190202011929-26bc712632e1
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.0.0-20190202014047-491c94071cfa
