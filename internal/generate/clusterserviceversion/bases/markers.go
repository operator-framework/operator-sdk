...
func updateDescriptionsForGVKs(csv *operatorsv1alpha1.ClusterServiceVersion, apisDir string,
	gvks []schema.GroupVersionKind) error {

	gvkMap := make(map[schema.GroupVersionKind]operatorsv1alpha1.CRDDescription)
