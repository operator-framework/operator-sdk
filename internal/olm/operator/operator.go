...
func (c *PackageManifestsCmd) AddToFlagSet(fs *pflag.FlagSet) {
	...
	fs.StringVar(&c.ManifestsDir, "manifests", "",
		flagPrefix+"Directory containing operator package directories and a package manifest file")
	fs.StringVar(&c.OperatorVersion, "operator-version", "",
		flagPrefix+"Version of operator to deploy")
	fs.StringSliceVar(&c.IncludePaths, "include", nil,
		flagPrefix+"Path to Kubernetes resource manifests, ex. Role, Subscription. "+
