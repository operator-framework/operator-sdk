...
type OLMCmd struct {
	...
	// OLMResourcePaths are path to manifests of OLM resources that override
	// defaults generated by methods of OLMCmd. These manifests can be but are
	// not limited to: Subscriptions, CatalogSources, OperatorGroups.
	OLMResourcePaths []string
...
func (c *OLMCmd) AddToFlagSet(fs *pflag.FlagSet) {
	fs.StringVar(&c.ManifestsDir, "manifests-dir", "", "Directory containing bundled operator manifests")
	fs.StringVar(&c.OperatorVersion, "operator-version", "", "Version of operator to deploy")
	fs.StringSliceVar(&c.OLMResourcePaths, "resources", nil, "Path to OLM resource manifests, ex. a Subscription. These override defaults generated by up/down")
